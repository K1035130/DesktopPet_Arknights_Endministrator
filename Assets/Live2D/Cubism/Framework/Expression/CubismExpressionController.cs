...
namespace Live2D.Cubism.Framework.Expression
{
    ...
    public class CubismExpressionController : MonoBehaviour, ICubismUpdatable
    {
        ...
        public void OnLateUpdate()
        {
            ...
            // Update of expressions when click. 
        ...
        /// <summary>
        /// Update of expressionsIndex when click.
        /// </summary>
        //private void SwitchToNextExpression()
        //{
        //    if (ExpressionsList == null || _playingExpressions.Count == 0)
        //        return;

        //    CurrentExpressionIndex++;
        //    if (CurrentExpressionIndex >= _playingExpressions.Count)
